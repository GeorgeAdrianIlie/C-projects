    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            if (conversionType && type > 0 && type < Nine)
            {
                ...
                {
                    ConvertShiftLeft(input);
                }
                else if (type == ShiftRight)
                {
                    ConvertShiftRight(input);
                }
        ...
        static void ConvertShiftLeft(string input)
        {
            char[] figures = input.ToCharArray();
            int shiftLeftSide = Convert.ToInt32(Console.ReadLine());
            int inedexReference = input.Length + shiftLeftSide;
            if (CheckValidity(figures))
            {
                for (int i = input.Length; i < inedexReference; i++)
                {
                    input += '0';
                }
            }
        ...
        static void ConvertShiftRight(string input)
        {
            char[] figures = input.ToCharArray();
            string newInput = Console.ReadLine();
            bool testNum = int.TryParse(newInput, out int num);
            if (num < 0)
            {
                input = "";
            ...
            {
                if (testNum && CheckValidity(figures) && num < input.Length)
                {
                    input = input.Remove(input.Length - num);
                }
                else if (testNum && CheckValidity(figures) && num >= input.Length)
                {
                    input = "0";
                }
            }
        ...
        static void ConvertToOr(string input)
        {
            ...
            {
                AddPadingLeft(ref toCompare, ref orString);
        ...
        static void ConvertToAnd(string input)
        {
            ...
            {
                AddPadingLeft(ref toAnd, ref andString);
        ...
        static void ConvertToXor(string input)
        {
            ...
            if (CheckValidity(andFigures))
            {
                AddPadingLeft(ref toXor, ref xorString);
        ...
        // static void AddPadingRight(ref string param1, ref string param2)
        // {
        //     if (param1.Length > param2.Length)
        //     {
        //         param2 = param2.PadRight(param1.Length, '0');
        //     }
        //     else if (param2.Length > param1.Length)
        //     {
        //         param1 = param1.PadRight(param2.Length, '0');
        //     }
        // }
